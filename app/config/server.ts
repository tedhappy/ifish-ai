...
export const getServerSideConfig = () => {
  ...
  return {
    ...
    serverBaiduConfigured: isBaidu,
    serverBytedanceConfigured: isBytedance,
    serverAlibabaConfigured: isAlibaba,
    serverTencentConfigured: isTencent,
    serverMoonshotConfigured: isMoonshot,
    serverIflytekConfigured: isIflytek,
    serverDeepSeekConfigured: isDeepSeek,
    serverXAIConfigured: isXAI,
    serverChatGLMConfigured: isChatGLM,
    serverSiliconFlowConfigured: isSiliconFlow,
    serverStabilityConfigured: isStability,
