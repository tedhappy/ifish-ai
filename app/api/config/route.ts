...
const DANGER_CONFIG = {
  ...
  compareDefaultDeepSeekModel: serverConfig.compareDefaultDeepSeekModel,
  compareDefaultByteDanceModel: serverConfig.compareDefaultByteDanceModel,
  compareDefaultAlibabaModel: serverConfig.compareDefaultAlibabaModel,
  compareDefaultBaiduModel: serverConfig.compareDefaultBaiduModel,
  compareDefaultTencentModel: serverConfig.compareDefaultTencentModel,
  compareDefaultMoonshotModel: serverConfig.compareDefaultMoonshotModel,
  compareDefaultChatGLMModel: serverConfig.compareDefaultChatGLMModel,
